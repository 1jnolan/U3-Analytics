...
***
The BAUDRATE of an Arduino is 9,600 bps
The BAUDRATE of an Raspberry Pi is 9,600 bps
...
while True:
    ...
    if len(data)>0:#provided there is no error in the data
        #print(data) #- you can print it to check if you wish
        file=open("temperatures.csv", 'a')#open the csv
        file.write(data+",") #write the data in plus a comma to seperate each item
